...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[80vh] flex-col items-center justify-center overflow-hidden bg-[#050505] w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-[#D4AF37] opacity-20 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-[#F3E5AB] opacity-30 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
